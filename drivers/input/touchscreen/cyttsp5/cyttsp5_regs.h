...
#define tp_log_err(fmt, ...) pr_err("cyttsp5: " fmt, ##__VA_ARGS__)
#define tp_log_warning(fmt, ...) pr_warn("cyttsp5: " fmt, ##__VA_ARGS__)
#define tp_log_info(fmt, ...) pr_info("cyttsp5: " fmt, ##__VA_ARGS__)
#define tp_log_debug(fmt, ...) pr_debug("cyttsp5: " fmt, ##__VA_ARGS__)
#define tp_log_vdebug(fmt, ...) pr_debug("cyttsp5: " fmt, ##__VA_ARGS__)
